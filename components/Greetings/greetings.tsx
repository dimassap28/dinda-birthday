                ...
                <div className="relative">
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-xl sm:text-center">
                            <h2 className="text-lg font-semibold leading-8 tracking-tight text-indigo-600">Orison</h2>
                                        ...
                                        >
                                            {column.map((testimonial) => (
                                                <figure
                                                    ...
                                                    className="rounded-2xl bg-white p-6 shadow-lg shadow-[#ff80b5]/50 ring-1 ring-gray-900/5"
                                                >
